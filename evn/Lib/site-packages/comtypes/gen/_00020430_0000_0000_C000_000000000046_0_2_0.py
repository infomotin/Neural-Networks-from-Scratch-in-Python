...
IFontDisp = Font
__all__ = [ 'FONTNAME', 'IPicture', 'Color', 'OLE_OPTEXCLUSIVE',
           'OLE_YPOS_HIMETRIC', 'OLE_TRISTATE', 'OLE_XSIZE_PIXELS',
           'FONTBOLD', 'OLE_YPOS_PIXELS', 'IFontEventsDisp',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_PIXELS', 'IPictureDisp',
           'OLE_XPOS_CONTAINER', 'OLE_YSIZE_HIMETRIC', 'Gray',
           'StdPicture', 'IFont', 'VgaColor', 'StdFont', 'FONTITALIC',
           'Font', 'OLE_YSIZE_CONTAINER', 'FONTSIZE', 'OLE_COLOR',
           'Monochrome', 'OLE_XSIZE_CONTAINER', 'OLE_XSIZE_HIMETRIC',
           'FONTSTRIKETHROUGH', 'FontEvents', 'Checked',
           'FONTUNDERSCORE', 'LoadPictureConstants',
           'OLE_YPOS_CONTAINER', 'IFontDisp', 'Picture', 'Default',
           'OLE_HANDLE', 'OLE_ENABLEDEFAULTBOOL', 'Unchecked',
           'OLE_XPOS_PIXELS', 'OLE_CANCELBOOL']
from comtypes import _check_version; _check_version('', 1517596604.018999)
